...
def scan_area(vehicle, result_queue, seq, center_lat, center_lon, alt, area_meter, distance_meter, drone_id: int=None):
    last_seq, last_wp = vehicle.scan_area_list(seq=seq, center_lat=center_lat, center_lon=center_lon, alt=alt, area_meter=area_meter, distance_meter=distance_meter, drone_id=drone_id)
...
try:
    ...
    korfez_scan_values1 = vehicle.scan_area_list(1, korfez_pos[0], korfez_pos[1], korfez_alt, korfez_scan_meter, korfez_distance_meter, korfez_id)
    korfez_scan_values2 = vehicle.scan_area_list(korfez_scan_values1[0] + 1, korfez_pos[0], korfez_pos[1], korfez_alt, korfez_scan_meter2, korfez_distance_meter2, korfez_id)

    alaca_scan_values = queue.Queue()
    # ALACA WAYPOINTLER
